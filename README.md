...
| 200,000-digit PRPs | 1 |
| **Proven prime (ECPP)** | **Q(10²⁴⁹⁹ + 3469), 9,997 digits** |

> The 200,000-digit PRP is **Q(10⁴⁹⁹⁹ + 7,506,520)** (199,997 digits), the largest known (probable) prime of the form n⁵−(n−1)⁵ as of March 2026. Its PFGW expression is stored in [`data/pfgw/pfgw_200k.log`](data/pfgw/pfgw_200k.log).
...
│
├── paper/
│   ├── Q5_primes_paper_FINAL.tex   # LaTeX source
│   └── Q5_primes_paper_FINAL.pdf   # Compiled paper
│
├── src/
...
│   ├── pfgw/
│   │   ├── pfgw_10k_expressions.log  # 133 PRPs in expression form (offsets ≥ 203,823)
│   │   ├── pfgw_10k_raw_values.log   # 42 PRPs as raw 9,997-digit numbers (offsets ≤ 190,434); 133+42 = 175 total
│   │   ├── pfgw_50k.log              # 2 PRPs (~50,000 digits)
│   │   ├── pfgw_100k.log             # 1 PRP (~100,000 digits)
│   │   └── pfgw_200k.log             # 1 PRP (~200,000 digits)
│   ├── tuplets/
